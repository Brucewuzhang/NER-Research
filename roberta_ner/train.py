...
def main():
    ...
    parser.add_argument('--version', type=str, help='bert version', default='roberta-base')
    ...
    if not feature_extraction:
        model = RobertaNER(label_size, dropout_rate=dropout_rate, initializer_range=0.02,
